...
Refer [Wolf-Bot](https://github.com/VEEROBOT/Wolf-Bot) link to understand and install Ubuntu for Wolf.
The below script installs ROS Noetic version and can only be installed on a compatible Ubuntu Version
